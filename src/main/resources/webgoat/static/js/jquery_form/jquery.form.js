/*!
 * jQuery Form Plugin
 * version: 3.51.0-2014.06.20 (security-hardened)
    ...
    $.fn.ajaxSubmit = function(options) {
        ...
        function fileUploadIframe(a) {
            ...
            function getDoc(frame) {
                // See comments in original plugin re: IE/SSL
                var doc = null;
                ...
                try {
                    ...
                    log("cannot get iframe.contentDocument: " + err2);
                    doc = frame.document;
                }
                return doc;
            }
            ...
            function cb(e) {
                ...
                try {
                    ...
                    try {
                        ...
                        status = "parsererror";
                        xhr.error = errMsg = err4 || status;
                    }
                } catch (err5) {
                    log("error caught: ", err5);
                    status = "error";
                    xhr.error = errMsg = err5 || status;
                }
            ...
            var httpData = function(xhr, type, s) {
                ...
                if (typeof data === "string") {
                    if (type === "json" || (!type && ct.indexOf("json") >= 0)) {
                        ...
                        // Hardened: do NOT auto-execute scripts.
                        // Return raw script as string. Callers who truly need execution
                        // must explicitly opt-in, avoiding CWE-94 here.
                    }
                }
                return data;
            };
