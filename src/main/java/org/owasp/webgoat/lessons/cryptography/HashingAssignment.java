...
import java.security.SecureRandom; // Secure replacement for java.util.Random
...
public class HashingAssignment implements AssignmentEndpoint {
    ...
    /**
     * SecureRandom singleton holder to avoid re-seeding issues and ensure thread safety.
     */
    static final class SecureRandomHolder {
