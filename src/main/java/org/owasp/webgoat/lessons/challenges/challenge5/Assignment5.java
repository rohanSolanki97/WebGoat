...
public class Assignment5 implements AssignmentEndpoint {
  ...
  public AttackResult login(
    ...
    } catch (SQLException e) { // Added specific catch for SQLException
      log.error("Database error during login attempt", e); // Log the exception
      return failed(this).feedback("An unexpected error occurred.").build();
    }
  }
}
